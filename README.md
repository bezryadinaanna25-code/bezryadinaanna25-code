...
🚀 **Контент-завод** — пост генерирует Claude, скрипт сам публикует в Telegram и VK с видео или фото  
📊 **Автоподбор рекламных каналов** — Claude Code анализирует базу и выбирает каналы под конкретный вебинар  
🌐 **Сайт музыканта** — создан с помощью ИИ-инструментов  
